...
public class NewestAbility extends AbilityBase {

    public final static AbilitySettings config = new AbilitySettings(NewestAddon.getAddonFile("NewestAbility.yml"));

    public NewestAbility(Participant arg0) {
        super(arg0);
    }
    ...
    public static class Config<T> extends SettingObject<T> {
        ...
        public Config(Class<? extends NewestAbility> aClass, String name, T value, String[] description, Condition condition, Predicate<T> predicate) {
            config.super(aClass, name, value, description);
            this.condition = condition;
            this.predicate = predicate;
        }

        public Config(Class<? extends NewestAbility> aClass, String name, T value, String... description) {
            this(aClass, name, value, description, Condition.NORMAL, a -> true);
        }

        public Config(Class<? extends NewestAbility> aClass, String name, T value, Condition arg3) {
            this(aClass, name, value, new String[]{}, arg3, a -> true);
        }

        public Config(Class<? extends NewestAbility> aClass, String name, T value) {
            this(aClass, name, value, new String[]{}, Condition.NORMAL, a -> true);
        }

        public Config(Class<? extends NewestAbility> aClass, String name, T value, Predicate<T> predicate) {
            this(aClass, name, value, new String[]{}, Condition.NORMAL, predicate);
        }

        public Config(Class<? extends NewestAbility> aClass, String name, T value, Predicate<T> predicate, String... description) {
